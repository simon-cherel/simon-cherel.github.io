...
const bladeDiffuse= "materials/blade_diffuse.jpg"
const bladeAlpha= "materials/blade.jpg"
...
export default function Grass({ options = { bW: 0.12, bH: 1, joints: 5 }, width = 100, instances = 50000, ...props }) {
  ...
  const baseGeom = useMemo(() => new THREE.PlaneBufferGeometry(bW, bH, 1, joints).translate(0, bH / 2, 0), [bH, bW, joints])
